...
class _SideBarScreenState extends State<SideBarScreen> with SingleTickerProviderStateMixin {
  final List<Map<String, dynamic>> _items = <Map<String, dynamic>>[
    ...
    <String, dynamic>{"index": 2, "title": "Tasks", "icon": FontAwesomeIcons.listCheck, "visited": false},
    <String, dynamic>{"index": 3, "title": "Appointments", "icon": FontAwesomeIcons.calendarDays, "visited": false},
    <String, dynamic>{"index": 4, "title": "Chats", "icon": FontAwesomeIcons.solidEnvelope, "visited": false},
    <String, dynamic>{"index": 5, "title": "Contacts", "icon": FontAwesomeIcons.users, "visited": false},
  ];
                      ...
                      return AnimatedContainer(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            const Spacer(),
                            if (!_hideSidebar) const SettingsStack() else Padding(padding: const EdgeInsets.all(8.0), child: IconButton(onPressed: () {}, icon: const Icon(FontAwesomeIcons.gear, color: grey, size: 20))),
